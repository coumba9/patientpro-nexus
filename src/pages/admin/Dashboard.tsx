          ...
          {selectedDoctor && (
            <div className="space-y-4 mt-4">
              <div className="flex flex-col items-center mb-4">
                ...
                <h2 className="text-xl font-bold">{selectedDoctor.first_name} {selectedDoctor.last_name}</h2>
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                ...
                <div className="flex items-start gap-3">
                  ...
                  <div>
                    ...
                    <p>{new Date(selectedDoctor.created_at).toLocaleDateString('fr-FR')}</p>
                  </div>
                </div>
                <div className="flex items-start gap-3">
                  ...
                  <div>
                    ...
                    <p>{selectedDoctor.years_of_experience} ans</p>
                  </div>
                </div>
              </div>
