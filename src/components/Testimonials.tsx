...
const testimonials = [{
  name: "Marie Dubois",
  role: "Patiente",
  content: "Une plateforme qui a révolutionné ma façon de gérer ma santé. Plus besoin d'attendre des heures au téléphone pour prendre rendez-vous !",
  rating: 5,
      ...
      <div className="max-w-7xl mx-auto relative">
        ...
        once: true
          ...
          <h2 className="text-4xl md:text-5xl lg:text-6xl font-bold mb-6">
            Ce que disent nos{" "}
            <span className="bg-clip-text bg-[var(--gradient-primary)] text-card-foreground">
              patients
            </span>
          </h2>
        ...
        <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
          ...
          scale: 1.02
              ...
              <div className="flex gap-1 mb-6">
                {[...Array(5)].map((_, i) => <Star key={i} className={`h-6 w-6 transition-colors ${i < testimonial.rating ? "fill-secondary text-secondary" : "fill-muted text-muted"}`} />)}
              </div>
